...
while True:
    token = input(
        f'{Style.BRIGHT}{Fore.MAGENTA}Put Your Token{Style.RESET_ALL}{Fore.RESET}\n >'
    )
    guild_s = input(
...
async def on_ready():
    try:
        ...
        print(
            f"{Style.BRIGHT}{Fore.BLUE} GhoSty Cloner Logged In As {Fore.YELLOW}{client.user.name}!{Fore.BLUE} Starting...{Style.RESET_ALL}{Fore.RESET}"
        )
        print(f"\n")
        ...
        print(
            f"{Style.BRIGHT}{Fore.BLUE}Do Not Skid Made By: {Fore.YELLOW}GhoSty {Style.RESET_ALL}"
        )
        print(
            f"{Style.BRIGHT}{Fore.BLUE}Our Discord Server: {Fore.YELLOW} https://discord.gg/jJ5QVWqe {Style.RESET_ALL}")
        print(
